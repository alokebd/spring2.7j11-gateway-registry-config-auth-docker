package com.adas.productservice.jwt;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private String parseJwt(HttpServletRequest request) {
        ...
        log.info("Product Service: AuthTokenFilter | parseJwt | headerAuth: {}", headerAuth);

        if (StringUtils.hasText(headerAuth) && !headerAuth.startsWith("Bearer ")) {
        	headerAuth = "Bearer ".concat(headerAuth);
        }
        log.info("AuthTokenFilter | parseJwt | Bearer token: {}", headerAuth);
